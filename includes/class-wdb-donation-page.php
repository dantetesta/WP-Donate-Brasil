        ...
        <div id="wdb-donation-wrapper">
            ...
            <div class="wdb-container">
                ...
                function wdbRenderWise(method) {
                    ...
                    html += '<img src="' + wiseLogoUrl + '" alt="Wise" style="height:60px;margin-bottom:20px;">';
                    ...
                    html += '<span style="font-size:18px;font-weight:600;color:#163300;">@' + method.wise_tag + '</span>';
                    html += '<button type="button" onclick="wdbCopy(\'@' + method.wise_tag + '\', this)" style="padding:6px 10px;background:#e5e7eb;color:#374151;border:none;border-radius:6px;cursor:pointer;transition:all 0.3s;font-size:12px;"><i class="fas fa-copy"></i></button>';
                    html += '</div>';
                    html += '</div>';
                    html += '<div style="text-align:center;">';
                    html += '<a href="' + wiseUrl + '" target="_blank" style="color:#163300;text-decoration:underline;font-size:14px;">';
                    html += '<i class="fas fa-external-link-alt" style="margin-right:5px;"></i>Abrir no Wise</a>';
                    html += '</div>';
